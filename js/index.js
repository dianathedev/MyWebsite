...
$(document).ready(function() {
    ...
    var recentTrackUrl = "https://ws.audioscrobbler.com/2.0?method=user.getRecentTracks&user=dianathedev&limit=200&api_key=a8de5ee9631ba5026c38ead04e2e47a7&format=json";
    var defaultCoverImage = "https://cdn.last.fm/flatness/responsive/2/noimage/default_album_300_g4.png";
    var refreshTime = 50; //look for updated JSON every "xxx" miliseconds

    //defining the function which gets JSON data from the last.fm api and sets it to the
